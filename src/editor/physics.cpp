...
Editor::Physics::Plane::Plane(const glm::vec3 &normal, float distance)
    : normal(normal),
      distance(distance)
{
}
float Editor::Physics::Plane::getDistance(const glm::vec3 &point) const
{
    return glm::dot(normal, point) - distance;
}

Editor::Physics::ConvexHull::ConvexHull(const std::vector<glm::vec3> &vertices)
    : vertices(vertices)
{
    computeCentroid();
    computePlanes();
}
void Editor::Physics::ConvexHull::computeCentroid()
{
...
void Editor::Physics::ConvexHull::computePlanes()
{
    planes.clear();
...
const std::vector<glm::vec3> &Editor::Physics::ConvexHull::getVertices() const
{
    return vertices;
}
const std::vector<Editor::Physics::Plane> &Editor::Physics::ConvexHull::getPlanes() const
{
    return planes;
}
glm::vec3 Editor::Physics::ConvexHull::getCentroid() const
{
    return centroid;
}
bool Editor::Physics::ConvexHull::contains(const glm::vec3 &point) const
{
...
float Editor::Physics::ConvexHull::getDistance(const glm::vec3 &point) const
{
...
glm::vec3 Editor::Physics::ConvexHull::getSupport(const glm::vec3 &direction) const
{
...
Editor::Physics::ConvexHull Editor::Physics::ConvexHull::createBox(const glm::vec3 &halfExtents)
{
...
Editor::Physics::ConvexHull Editor::Physics::ConvexHull::createSphere(float radius, int subdivisions)
{
    std::vector<glm::vec3> vertices;
...
Editor::Physics::ConvexHull Editor::Physics::ConvexCollider::getTransformedHull() const
{
...
Editor::Physics::Rigidbody::Rigidbody(const glm::vec3 &pos, float mass, const ConvexHull &hull)
    : position(pos),
      velocity(0.f),
      acceleration(0.f),
      rotation(1.f),
...
void Editor::Physics::Rigidbody::computeInertiaTensor()
{
...
glm::vec3 Editor::Physics::Rigidbody::getPosition() const
{
    return position;
}
glm::vec3 Editor::Physics::Rigidbody::getVelocity() const
{
    return velocity;
}
glm::vec3 Editor::Physics::Rigidbody::getAngularVelocity() const
{
    return angularVelocity;
}
float Editor::Physics::Rigidbody::getMass() const
{
    return mass;
}
float Editor::Physics::Rigidbody::getInverseMass() const
{
    return inverseMass;
}
float Editor::Physics::Rigidbody::getRestitution() const
{
    return restitution;
}
float Editor::Physics::Rigidbody::getFriction() const
{
    return friction;
}
Editor::Physics::ConvexCollider &Editor::Physics::Rigidbody::getCollider()
{
    return collider;
}
const Editor::Physics::ConvexCollider &Editor::Physics::Rigidbody::getCollider() const
{
    return collider;
}
bool Editor::Physics::Rigidbody::getIsStatic() const
{
    return isStatic;
}
void Editor::Physics::Rigidbody::setPosition(const glm::vec3 &pos)
{
    position = pos;
    collider.position = pos;
}
void Editor::Physics::Rigidbody::setVelocity(const glm::vec3 &vel)
{
    velocity = vel;
}
void Editor::Physics::Rigidbody::setAngularVelocity(const glm::vec3 &angVel)
{
    angularVelocity = angVel;
}
void Editor::Physics::Rigidbody::setRotation(const glm::mat3 &rot)
{
    rotation = rot;
    collider.rotation = rot;
}
void Editor::Physics::Rigidbody::setRestitution(float rest)
{
    restitution = glm::clamp(rest, 0.f, 1.f);
}
void Editor::Physics::Rigidbody::setFriction(float fric)
{
    friction = glm::clamp(fric, 0.f, 1.f);
}
void Editor::Physics::Rigidbody::setStatic(bool stat)
{
    isStatic = stat;
    inverseMass = isStatic ? 0.f : 1.f / mass;
}
void Editor::Physics::Rigidbody::applyForce(const glm::vec3 &force)
{
    if (isStatic)
    {
        return;
...
void Editor::Physics::Rigidbody::applyImpulse(const glm::vec3 &impulse, const glm::vec3 &contactPoint)
{
    if (isStatic)
    {
        return;
...
void Editor::Physics::Rigidbody::applyAngularImpulse(const glm::vec3 &impulse)
{
    if (isStatic)
    {
        return;
...
void Editor::Physics::Rigidbody::update(float deltaTime)
{
...
void Editor::Physics::Rigidbody::clearForces()
{
    acceleration = glm::vec3(0.f);
}

Editor::Physics::PhysicsSystem::PhysicsSystem(const glm::vec3 &gravity)
    : gravity(gravity),
      solverIterations(4)
{
}
Editor::Physics::Rigidbody *Editor::Physics::PhysicsSystem::addBody(const glm::vec3 &pos, float mass, const ConvexHull &hull)
{
    bodies.push_back(std::make_unique<Rigidbody>(pos, mass, hull));
    return bodies.back().get();
}
void Editor::Physics::PhysicsSystem::removeBody(Rigidbody *body)
{
...
void Editor::Physics::PhysicsSystem::setGravity(const glm::vec3 &gravity)
{
    this->gravity = gravity;
}
glm::vec3 Editor::Physics::PhysicsSystem::getGravity() const
{
    return gravity;
}
void Editor::Physics::PhysicsSystem::update(float deltaTime)
{
...
const std::vector<std::unique_ptr<Editor::Physics::Rigidbody>> &Editor::Physics::PhysicsSystem::getBodies() const
{
    return bodies;
}
void Editor::Physics::PhysicsSystem::applyGravity(float deltaTime)
{
    for (auto &body : bodies)
    {
        if (!body->getIsStatic())
...
void Editor::Physics::PhysicsSystem::resolveCollisions()
{
...
bool Editor::Physics::PhysicsSystem::convexConvexCollision(Rigidbody &bodyA, Rigidbody &bodyB, CollisionManifold &manifold)
{
...
void Editor::Physics::PhysicsSystem::resolveCollision(Rigidbody &bodyA, Rigidbody &bodyB, const CollisionManifold &manifold)
{
