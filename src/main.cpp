...
int render()
{
    ...
    Editor::Image png1("assets/textures/checkerboard.png");

    Editor::MeshWithTexture mesh1("assets/shaders/texture",
    ...
    Editor::Image png2("assets/textures/checkerboard-w-color.png");
    Editor::MeshWithTexture mesh2("assets/shaders/texture",
                                  {1.0f, -1.0f, -1.0f, // triangle 1 : begin
                                   1.0f, -1.0f, 1.0f,
                                   1.0f, 1.0f, 1.0f,  // triangle 1 : end
    ...
    Editor::MeshWithTexture mesh3("assets/shaders/texture",
                                  {1.0f, -1.0f, 1.0f, // triangle 1 : begin
                                   1.0f, -1.0f, 3.0f,
